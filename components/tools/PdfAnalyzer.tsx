...
const copy = {
  en: {
    ...
    sampleNote: "Sample demos and uploaded reports are Pro diagnostics before printing postage.",
    ...
    safeText: "The PDF page size looks ready. Run a Pro test print or calibration sheet before printing paid labels in bulk.",
  ...
  zh: {
    ...
    sampleNote: "示例演示和上传报告都属于打印运单前的 Pro 诊断。",
    busy: "正在本地分析...",
