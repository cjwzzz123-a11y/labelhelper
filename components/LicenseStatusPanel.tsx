...
const copy = {
  en: {
    ...
    previewText: "You can use free tools and watermarked previews now. Real purchase verification appears here after checkout, webhook, storage and email credentials are connected.",
  ...
  zh: {
    ...
    previewText: "现在可以使用免费工具和带水印预览。真实购买验证会在结账、webhook、存储和邮件凭证接入后显示。",
