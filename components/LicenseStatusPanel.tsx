...
const copy = {
  ...
  es: {
    ...
    previewTitle: "El acceso de pago aún no está conectado por completo",
    ...
    previewText: "Las guías y páginas de referencia siguen disponibles. El acceso a herramientas de pago aparecerá cuando checkout, webhook, almacenamiento y email estén conectados.",
  ...
  fr: {
    ...
    previewTitle: "L'accès payant n'est pas encore entièrement connecté",
    ...
    previewText: "Les guides et pages de référence restent disponibles. L'accès aux outils payants apparaîtra lorsque checkout, webhook, stockage et e-mail seront connectés.",
  ...
  de: {
    ...
    previewTitle: "Bezahlzugang ist noch nicht vollständig verbunden",
    ...
    previewText: "Guides und Referenzseiten bleiben verfügbar. Der Zugriff auf bezahlte Tools erscheint, wenn Checkout, Webhook, Speicherung und E-Mail verbunden sind.",
  ...
  ja: {
    ...
    previewTitle: "有料アクセスはまだ完全には接続されていません",
    testTitle: "ローカルテストモードが有効です",
    readyText: "checkout、webhook、storage、email が設定済みです。購入キーを入力するとこのブラウザで有料ツールを解除できます。",
    previewText: "ガイドと参考ページは引き続き利用できます。有料ツールのアクセスは checkout、webhook、storage、email 接続後に表示されます。",
