...
const copy = {
  en: {
    ...
    text: "Use the free checker and preview tools first. Paid access unlocks watermark-free output, saved reports and deeper checks once checkout and license delivery are connected.",
  ...
  zh: {
    ...
    text: "请先使用免费检查器和预览工具。付费访问会解锁无水印输出、保存报告和更深入检查；结账与许可证发送接入后会开放。",
    paidLabel: "付费解锁内容",
