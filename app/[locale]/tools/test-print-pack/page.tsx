...
const copy = {
  en: {
    ...
    description: "VIP tool: unlock a local ZIP with 30+ shipping-label test PDFs for printer alignment, barcode quiet zones and 100% scale checks. Single watermarked previews stay free.",
    tools: "Tools",
    name: "Test Print Pack",
    badge: "Paid preview",
    h1: "Shipping Label Test Print Pack",
    intro: "Download single watermarked previews for free, then unlock the bundled ZIP when you need the full printer test set without evaluation watermarks.",
  ...
  zh: {
    title: "运单标签测试打印包",
    description: "VIP 工具：解锁本地 ZIP，包含多个运单标签测试 PDF，用于检查打印机对齐、条码空白区和 100% 打印比例。单个带水印预览保持免费。",
    tools: "工具",
    name: "测试打印包",
    badge: "付费预览",
    h1: "运单标签测试打印包",
    intro: "免费用户可下载单个带水印预览；当需要完整测试打印集合且不要评估水印时，再解锁打包 ZIP。",
