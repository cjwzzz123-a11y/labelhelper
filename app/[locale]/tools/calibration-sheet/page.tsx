...
const copy = {
  en: {
    ...
    intro: "Generate a watermarked preview PDF with corner guides, a 100 mm reference line, center crosshair and quiet-zone reference. Use it before printing real postage.",
    ...
    boundaryBadge: "Preview boundary",
    boundaryTitle: "Free downloads are watermarked",
    boundaryText: "The current generator creates browser-local watermarked previews. Watermark-free downloads and saved printer profiles are part of the paid flow once checkout and license delivery are connected.",
  ...
  zh: {
    ...
    badge: "先打印空白测试",
    h1: "校准页生成器",
    intro: "生成带水印预览 PDF，包含角落参考、100 mm 参考线、中心十字线和空白区参考。请在打印真实运费前使用。",
    ...
    boundaryBadge: "预览边界",
    boundaryTitle: "免费下载带水印",
    boundaryText: "当前生成器会在浏览器本地创建带水印预览。无水印下载和保存打印机配置属于结账与许可证发送接入后的付费流程。",
