...
const copy = {
  en: {
    ...
    intro: "When checkout is connected, this page will confirm your order and send the license key to your email. For now, the free tools and watermarked previews remain available.",
  ...
  zh: {
    ...
    intro: "结账接入后，此页面会确认订单并把许可证密钥发送到你的邮箱。当前仍可使用免费工具和带水印预览。",
    unlock: "输入许可证密钥",
    tools: "返回工具",
    nextBadge: "接下来会发生什么",
