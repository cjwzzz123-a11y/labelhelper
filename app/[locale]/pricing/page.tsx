...
const uiCopy = {
  en: {
    ...
    decisionTitle: "Read the free guides, then unlock Pro tools when you need checks or exports.",
    freeNeed: "Guides and references",
    freePath: "Use the free guides to decide what to check.",
    proNeed: "PDF, barcode or calibration tools",
    proPath: "Unlock Pro Toolkit for interactive workflows.",
    bestFor: "Best for",
    next: "What happens next",
    freeBest: "A seller researching label setup, template sizes and troubleshooting steps.",
    freeNext: "Read the guides and reference pages, then unlock Pro when you need an actual diagnostic.",
    ...
    proNextPreview: "Checkout and license delivery are shown when configured.",
    alreadyKey: "Already have a key?",
    templates: "Open templates",
    previewTools: "Open Pro previews",
    pdfPreview: "Open PDF Analyzer",
    useFree: "Read guides first",
  },
  es: {
    decisionEyebrow: "Elige según tu necesidad",
    decisionTitle: "Lee primero las guías gratuitas y desbloquea Pro cuando necesites comprobaciones o exportaciones.",
    freeNeed: "Guías y referencias",
    freePath: "Usa las guías gratuitas para decidir qué comprobar.",
    proNeed: "Herramientas de PDF, código de barras o calibración",
    proPath: "Desbloquea Pro Toolkit para usar los flujos interactivos.",
    bestFor: "Adecuado para",
    next: "Qué ocurre después",
    freeBest: "Vendedores que investigan configuración, tamaños de plantilla y pasos de solución.",
    freeNext: "Lee las guías; desbloquea Pro solo cuando necesites un diagnóstico interactivo.",
    proBest: "Vendedores que necesitan revisar tamaño de PDF, calibración o una imagen de código de barras.",
    proNextConfigured: "Paga con Creem e introduce la clave del recibo o portal del cliente.",
    proNextPreview: "El proceso real aparece cuando el checkout y la entrega de licencias están configurados.",
    alreadyKey: "¿Ya tienes una clave?",
    templates: "Abrir plantillas",
    previewTools: "Ver herramientas Pro",
    pdfPreview: "Abrir analizador PDF",
    useFree: "Leer guías primero",
  },
  fr: {
    decisionEyebrow: "Choisir selon le besoin",
    decisionTitle: "Lisez d’abord les guides gratuits, puis débloquez Pro pour les contrôles ou exports.",
    freeNeed: "Guides et références",
    freePath: "Utilisez les guides gratuits pour définir le contrôle nécessaire.",
    proNeed: "Outils PDF, code-barres ou calibration",
    proPath: "Débloquez Pro Toolkit pour les parcours interactifs.",
    bestFor: "Idéal pour",
    next: "Étape suivante",
    freeBest: "Les vendeurs qui recherchent les réglages, formats et étapes de dépannage.",
    freeNext: "Lisez les guides, puis débloquez Pro uniquement pour un diagnostic interactif.",
    proBest: "Les vendeurs qui doivent contrôler un PDF, une calibration ou une image de code-barres.",
    proNextConfigured: "Payez avec Creem, puis saisissez la clé du reçu ou du portail client.",
    proNextPreview: "Le parcours réel apparaît lorsque le paiement et la livraison de licence sont configurés.",
    alreadyKey: "Vous avez déjà une clé ?",
    templates: "Ouvrir les modèles anglais",
    previewTools: "Voir les outils Pro",
    pdfPreview: "Ouvrir l’analyseur PDF anglais",
    useFree: "Lire d’abord les guides",
  },
  de: {
    decisionEyebrow: "Nach Bedarf wählen",
    decisionTitle: "Lesen Sie zuerst die kostenlosen Leitfäden und schalten Sie Pro nur für Prüfungen oder Exporte frei.",
    freeNeed: "Leitfäden und Referenzen",
    freePath: "Nutzen Sie die kostenlosen Leitfäden, um die nötige Prüfung zu bestimmen.",
    proNeed: "PDF-, Barcode- oder Kalibrierungswerkzeuge",
    proPath: "Schalten Sie Pro Toolkit für interaktive Abläufe frei.",
    bestFor: "Geeignet für",
    next: "Nächster Schritt",
    freeBest: "Verkäufer, die Einrichtung, Vorlagengrößen und Fehlerbehebung recherchieren.",
    freeNext: "Lesen Sie die Leitfäden und schalten Sie Pro erst für eine interaktive Diagnose frei.",
    proBest: "Verkäufer, die PDF-Größe, Kalibrierung oder ein Barcode-Bild prüfen müssen.",
    proNextConfigured: "Sicher mit Creem zahlen und den Schlüssel aus Beleg oder Kundenportal eingeben.",
    proNextPreview: "Der echte Ablauf erscheint, sobald Checkout und Lizenzzustellung eingerichtet sind.",
    alreadyKey: "Schon einen Schlüssel?",
    templates: "Englische Vorlagen öffnen",
    previewTools: "Pro-Werkzeuge ansehen",
    pdfPreview: "Englischen PDF-Analysator öffnen",
    useFree: "Zuerst Leitfäden lesen",
  },
  ja: {
    decisionEyebrow: "必要な機能で選ぶ",
    decisionTitle: "まず無料ガイドを読み、確認や出力が必要な場合だけ Pro を解除します。",
    freeNeed: "ガイドと参考情報",
    freePath: "無料ガイドで、何を確認するか判断します。",
    proNeed: "PDF・バーコード・キャリブレーション",
    proPath: "Pro Toolkit で対話型の確認手順を利用します。",
    bestFor: "対象",
    next: "次の流れ",
    freeBest: "設定、テンプレートサイズ、対処手順を調べる販売者。",
    freeNext: "ガイドを読み、実際の診断が必要な場合だけ Pro を解除します。",
    proBest: "PDF サイズ、キャリブレーション、バーコード画像を確認したい販売者。",
    proNextConfigured: "Creem で支払い、領収書または顧客ポータルのキーを入力します。",
    proNextPreview: "決済とライセンス配信の設定後に実際の手順が表示されます。",
    alreadyKey: "キーをお持ちですか？",
    templates: "英語テンプレートを開く",
    previewTools: "Pro ツールを見る",
    pdfPreview: "英語 PDF 分析を開く",
    useFree: "まずガイドを読む",
  },
  zh: {
    decisionEyebrow: "按需求选择",
    decisionTitle: "先阅读免费指南；需要检查或导出时再解锁 Pro 工具。",
    freeNeed: "指南和参考资料",
    freePath: "先用免费指南判断要检查什么。",
    proNeed: "需要 PDF、条码或校准工具",
    proPath: "解锁 Pro Toolkit 后使用交互流程。",
    bestFor: "适合",
    next: "接下来会发生什么",
    freeBest: "正在研究标签设置、模板尺寸和排查步骤的卖家。",
    freeNext: "先阅读指南和参考页面；需要实际诊断时再解锁 Pro。",
    proBest: "需要 PDF 页面尺寸、校准页和条码图片复核的卖家。",
    proNextConfigured: "通过 Creem 安全支付后，输入收据或客户门户里的许可证密钥。",
    proNextPreview: "checkout 和许可证发送配置好后，会显示真实解锁流程。",
    alreadyKey: "已有密钥？",
    templates: "打开模板",
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        ...
        <section className="mt-8 rounded-[2rem] bg-white p-5 shadow-xl shadow-sky-900/10 ring-1 ring-sky-100 sm:p-6">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            {[
              [ui.freeNeed, ui.freePath, "/guides"],
